    ...
    def learn(self):
        for _ in range(self.n_epochs):
            ...
            for batch in batches:
                with tf.GradientTape(persistent=True) as tape:  # allows us to backpropagate twice
                    # in tf2 only thing in this context manager get counted towards the loss function
